...
<div class="h1 product1">
	...
	<h1 class="current"><a href="products.php">Productos GstarCAD </a></h1>
...
?>
	...
	<h1><a href="cases.php">Casos Reales</a></h1>
...
?>
	...
	<h1><a href="p_new.php"><?php echo $subnav_new["name"] ?></a></h1>
...
?>
	...
	<h1 class="current"><a href="cases.php">Casos Reales</a></h1>
...
?>
	...
	<h1 class="current"><a href="p_new.php"><?php echo $subnav_new["name"] ?></a></h1>
...
?>
	...
	<ul>
		...
		<li><a href="download.php?for=1" <?php echo $subnav_filename != "faq.php" ? 'class="current"' : "" ?>>Descarga</a></li>
...
?>
	...
	<h1 <?php echo $for == 2 || $subnav_filename == "reg_distributor.php" ? 'class="current"' : '' ?>><a href="download.php?for=2">Distribuidores</a></h1>
...
?>
	...
	<ul>
		...
		<li><a href="download.php?for=2" <?php echo $subnav_filename != "faq.php" ? 'class="current"' : "" ?>>Descarga</a></li>
...
?>
		...
		<div class="input" style="padding:10px;">
			...
			<a href="logout.php?returnUrl=<?php echo $_SERVER['PHP_SELF'] ?>" style="color:#658CB7;">Logout</a>
